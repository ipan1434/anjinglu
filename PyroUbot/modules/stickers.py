...
__MODULE__ = "ꜱᴛɪᴄᴋᴇʀ"
__HELP__ = """
⪼<b><u>Dokumen untuk Sticker</u></b>

<blockquote>📚perintah : <code>{0}q</code>
    merubah text menjadi sticker</blockquote>

<blockquote>📚perintah : <code>{0}kang</code>
    menambahkan sticker ke dalam pack</blockquote>

<blockquote>📚perintah : <code>{0}tiny</code>
    merubah sticker menjadi kecil</blockquote>

<blockquote>📚perintah : <code>{0}mmf</code>
