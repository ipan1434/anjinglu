...
<blockquote>👋🏻😄 HALOO</b></u><a href=tg://user?id={message.from_user.id}>{message.from_user.first_name} {message.from_user.last_name or ''}
• ᴘʏᴛʜᴏɴ: 3.10.12
• ᴘʏʀᴏɢᴀᴍ: 3.0.2
...
☁ silahkan pilih tombol dibawah ini</blockquote> 
"""
